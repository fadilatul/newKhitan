                             ...
                             <table id="example" class="display" style="min-width: 845px">
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="d-flex">
                                                 <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit" href="{{ route('edit_pasien', ['id' => $item->id]) }}"><i class="fa fa-pencil-alt"></i></a>
                                                         ...
                                                         <div class="modal-content">
                                                             ...
                                                             <div class="modal-footer">
                                                                 ...
                                                                 <form action="{{ route('delete-data', $item->id) }}" method="POST">
                                                                     @csrf
                                                                     <button type="submit" class="btn btn-danger shadow" data-id="{{ $item->id }}">
                                                                         Ya, Hapus Data!
                                                                     </button>
                                                                 </form>
                                                             </div>
